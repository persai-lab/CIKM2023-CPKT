...
from llpkt.utils.dirs import create_dirs
...
def setup_logging(log_dir):
    ...
    exp_file_handler.setLevel(logging.ERROR)
...
def process_config(json_file):
    ...
    elif "STATICS" in config.data_name:
        config.data_loader = "STATICSDataLoader"
    elif "FSAI" in config.data_name:
        config.data_loader = "FSAIDataLoader"
    elif "MasteryGrids" in config.data_name:
        config.data_loader = "MasteryGridsDataLoader"
    else:
    ...
    # if config.mode != "hyperparameters":
